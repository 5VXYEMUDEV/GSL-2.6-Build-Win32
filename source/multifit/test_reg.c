          ...
          gsl_multifit_linear_workspace * w, const char * desc)
{
  ...
  gsl_test_rel(rnorm*rnorm, chisq, tol,
               "test_reg1: %s, lambda = 0, n="PCTZ"u p="PCTZ"u chisq", desc, n, p);
  ...
  for (j = 0; j < p; ++j)
    {
      ...
      gsl_test_rel(c1j, c0j, tol, "test_reg1: %s, lambda = 0, n="PCTZ"u p="PCTZ"u c0/c1",
                   desc, n, p);
    }
          ...
          gsl_multifit_linear_workspace * w, const char * desc)
{
  ...
  gsl_test_rel(snorm0, snorm1, tol, "test_reg2: %s, snorm lambda=%g n="PCTZ"u p="PCTZ"u",
               desc, lambda, n, p);
  ...
  gsl_test_rel(rnorm0, rnorm1, tol, "test_reg2: %s, rnorm lambda=%g n="PCTZ"u p="PCTZ"u",
               desc, lambda, n, p);
  ...
  for (j = 0; j < p; ++j)
    {
      ...
      gsl_test_rel(c1j, c0j, tol, "test_reg2: %s, c0/c1 lambda=%g n="PCTZ"u p="PCTZ"u",
                   desc, lambda, n, p);
    }
          ...
          gsl_multifit_linear_workspace * w, const char * desc)
{
  ...
  gsl_test_rel(snorm0, snorm1, tol, "test_reg3: %s, snorm lambda=%g n="PCTZ"u p="PCTZ"u",
               desc, lambda, n, p);
  ...
  gsl_blas_dgemv(CblasNoTrans, -1.0, Xs, c1, 1.0, r);
  rnorm1 = gsl_blas_dnrm2(r);
  gsl_test_rel(rnorm0, rnorm1, tol, "test_reg3: %s, rnorm lambda=%g n="PCTZ"u p="PCTZ"u",
               desc, lambda, n, p);
  ...
  for (j = 0; j < p; ++j)
    {
      ...
      gsl_test_rel(c1j, c0j, tol, "test_reg3: %s, c0/c1 j="PCTZ"u lambda=%g n="PCTZ"u p="PCTZ"u",
                   desc, j, lambda, n, p);
    }
  ...
  for (j = 0; j < p; ++j)
    {
      ...
      gsl_test_rel(c1j, c0j, tol, "test_reg4: %s lambda=%g n="PCTZ"u p="PCTZ"u j="PCTZ"u",
                   desc, lambda, n, p, j);
    }
          ...
          for (j = 0; j < p; ++j)
            {
              ...
              gsl_test_rel(aij, bij, tol, "sobolov k="PCTZ"u LTL("PCTZ"u,"PCTZ"u)", k, i, j);
            }
        }
